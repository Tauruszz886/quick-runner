...
export const DASHBOARD_CENTER_Y = 540
...
export const BIRTH_SPAWN_X = 919
...
export const RUNTIME_COPY_COUNT = 10
...
export const EIGHTH_LEVEL_MECHANISM_MOVE_FRAMES = 25

export const FOURTH_LEVEL_PRESS_PLATE_FLOAT_GAP = 8
...
export const FOURTH_LEVEL_COMPRESSOR_WAIT_SECONDS = 2
export const FOURTH_LEVEL_COMPRESSOR_DOWN_SECONDS = 1
export const FOURTH_LEVEL_COMPRESSOR_UP_SECONDS = 1.5
export const FOURTH_LEVEL_COMPRESSOR_DROP_STAGE_COUNT = 3
export const FOURTH_LEVEL_COMPRESSOR_DROP_MOVE_FRAMES = 20
export const FOURTH_LEVEL_COMPRESSOR_RISE_STAGE_COUNT = 3
export const FOURTH_LEVEL_COMPRESSOR_RISE_MOVE_FRAMES = 20
